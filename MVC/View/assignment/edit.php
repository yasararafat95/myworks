...
<?php
                        if(form_error('atype'))
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="atype" class="col-sm-2 control-label">
                            <?=$this->lang->line("assignment_type")?>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                echo form_dropdown("atype", array(1 => $this->lang->line('assignment_type_a'), 2 => $this->lang->line('assignment_type_v')), set_value("atype",$assignment->atype), "id='atype' class='form-control'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('atype'); ?>
                        </span>
                    </div>
                    <?php 
